...
export default function PlacesSortBar(props: AppProps) {
    ...
    const [sortingDirectionAscending, setSortingDirectionAscending] = useState<boolean[]>([false, false, false]) //for 
    ...
    const changeThirdIndex = (event: SelectChangeEvent) => {
        ...
        if(chosenValue == "None"){
            ...
            setSortingBy(prev => {return[prev[0], prev[1], chosenValue]})
        }
    }
    ...
    return (
        ...
        backgroundColor: 'gray'
            ...
            <Stack direction="row" sx={{justifyContent: 'center' }}>
                <Box sx={{backgroundColor: 'white'}} mx={3}>
